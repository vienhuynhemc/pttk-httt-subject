...
public class QuanLyDonHangObjectNVK implements ObjectPageAdmin {
    ...
    private List<NguoiXuLyQuanLyDonHang> list_nvgh;

    public QuanLyDonHangObjectNVK(){
    ...
    public List<NguoiXuLyQuanLyDonHang> getList_nvgh() {
        return list_nvgh;
    }

    public void setList_nvgh(List<NguoiXuLyQuanLyDonHang> list_nvgh) {
        this.list_nvgh = list_nvgh;
    }
}
